...
ActionController::Routing::Routes.draw do |map|
  ...
  map.refresh_stats '/stats/refresh', 
      :controller => 'stats', 
      :action => 'refresh',
      :conditions => { :method => :post }, 
      :requirements => { :protocol => ROUTES_PROTOCOL }
...
#  map.destroy_tag '/tags', :controller => 'tags', :action => 'destroy', :conditions => { :method => :delete }
  ...
  # Ratings
  map.create_rating '/ratings', :controller => 'ratings', :action => 'create', :conditions => { :method => :post }, :requirements => { :protocol => ROUTES_PROTOCOL }
  map.destroy_rating '/ratings', :controller => 'ratings', :action => 'destroy', :conditions => { :method => :delete }, :requirements => { :protocol => ROUTES_PROTOCOL }
